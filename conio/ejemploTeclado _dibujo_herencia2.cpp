...
/***
ESTA CAMIONETA SE MUEVE SOLA

**/

class Camioneta2: public ObjetoDibuja{
	
public:
	Camioneta2(int x0,int y0,int vel);
	bool update();
...
Camioneta2::Camioneta2(int x0, int y0, int vel): ObjetoDibuja(vel){
...
class Juego{
	...
	Camioneta2 *camio2 = new Camioneta2(3,15,10); 
